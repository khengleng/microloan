...
export const SUPPORTED_CURRENCIES = [Currency.USD, Currency.KHR];
...
export function normalizeCurrency(value, fallback = Currency.USD) {
 ...
 */
export function convertCurrency(amount, from, to, rateFromTo) {
    if (from === to)
...
export function resolveInterestCap(tenantMaxAnnualPct) {
 ...
 */
export function checkInterestRateCap(annualRatePct, tenantMaxAnnualPct) {
